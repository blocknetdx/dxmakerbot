...
parser.add_argument('--delay', help='sleep delay, in seconds, between loops to place/cancel orders (default=3)', default=3, type=int)
parser.add_argument('--maxloop', help='number of loops before canceling the oldest order (default=7)', default=7, type=int)
parser.add_argument('--maxopen', help='max number of open orders (default=5)', default=5, type=int)
